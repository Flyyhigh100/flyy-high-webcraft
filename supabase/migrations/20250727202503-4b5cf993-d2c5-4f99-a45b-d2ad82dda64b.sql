...
-- Step 2: Restore admin profiles for existing users with correct IDs
-- Insert admin profile for flyyhigh824@gmail.com with correct ID
INSERT INTO profiles (id, user_id, email, role)
VALUES (
  '59e4e81c-05a8-41c4-bbe7-de4b23066255',
  '59e4e81c-05a8-41c4-bbe7-de4b23066255', 
...
-- Insert admin profile for chris.d.conley@gmail.com 
INSERT INTO profiles (id, user_id, email, role)
VALUES (
  '8970287b-ada6-42b6-996f-357667a5c6fb',
  '8970287b-ada6-42b6-996f-357667a5c6fb', 
  'chris.d.conley@gmail.com',
  'admin'
) ON CONFLICT (id) DO UPDATE SET
  role = 'admin',
  email = 'chris.d.conley@gmail.com';
