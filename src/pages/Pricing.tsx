                ...
                {features.map((feature, index) => (
                  <TableRow key={index} className={index % 2 === 0 ? 'bg-muted/20' : ''}>
                    ...
                    <TableCell className="px-6 py-4 whitespace-nowrap text-center">
                      {feature.basic === true ? <Check className="w-5 h-5 text-primary mx-auto" /> : feature.basic === false ? <span className="text-muted-foreground">—</span> : <span>{feature.basic}</span>}
                    </TableCell>
                    <TableCell className="px-6 py-4 whitespace-nowrap text-center bg-primary/5">
                      {feature.pro === true ? <Check className="w-5 h-5 text-primary mx-auto" /> : feature.pro === false ? <span className="text-muted-foreground">—</span> : <span>{feature.pro}</span>}
                    </TableCell>
                  </TableRow>
                ))}
              </TableBody>
